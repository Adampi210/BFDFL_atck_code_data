...
filename = '../../data/' + 'attack_%s_adv_pow_%s_adv_number_%s_atk_time_%s_architecture_%s.csv' % (attacks[attack_used], str(adv_pow), str(adv_number), attack_time, architectures[0])
