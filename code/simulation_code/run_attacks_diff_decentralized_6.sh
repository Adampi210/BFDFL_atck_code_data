...
sed -i "s/designated_clients = $prev_designated_clients/designated_clients = $init_designated_clients/g" full_decentralized_6.py
sed -i "s/config_graph_used = $prev_config_graph_used/config_graph_used = $init_config_graph_used/g" full_decentralized_6.py
                ...
                do
                    ...
                    do
                        ...
                        do
                            ...
                            sed -i "s/designated_clients = $prev_designated_clients/designated_clients = $designated_clients/g" full_decentralized_6.py
                            sed -i "s/config_graph_used = $prev_config_graph_used/config_graph_used = $config_graph_used/g" full_decentralized_6.py
